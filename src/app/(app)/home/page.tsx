...
export default async function MemberHome() {
  ...
  // Admins are routed to /admin, but if one lands here we still render their tasks.
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-muted-foreground">Here&rsquo;s what&rsquo;s on your plate.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatTile
          ...
          tone="danger"
          href="/tasks"
          hint={counts.overdue ? "Needs attention" : undefined}
        />
      </div>
